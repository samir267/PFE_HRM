 ...
 *         description: Internal server error
 */
router.post('/employees/:employeeId/phones', validationMiddleware(phoneValidationSchema), PhoneContactController.createPhoneContact);
 ...
 *         description: Internal server error
 */
router.put('/employees/:employeeId/phones/:phoneId', validationMiddleware(phoneValidationSchema), PhoneContactController.updatePhoneContact);
