...
// --- New Custom Dropdown Component (assuming it's in a separate file) ---
...
// --- New Interfaces for added functionalities ---
interface Address {
  street1: string;
  street2: string;
  city: string;
...
// --- Main Employee Information Interface (updated) ---
...
// New data for dropdowns (limited to 20 for example)
const allCountries = [
...
const PersonalInformation: React.FC = () => {
  ...
  // Effect to calculate age automatically
  useEffect(() => {
  ...
  // --- Updated handleChange for nested objects and new fields ---
    ...
    const updatedCitizenships = employeeData.citizenships.map((item, i) => {
      if (i === index) {
        if (name === 'primaryNationality' && value) {
          // Uncheck all other primary nationalities
          return { ...item, [name]: value };
        }
        return { ...item, [name]: value };
      } else if (name === 'primaryNationality' && value) {
        // If a new one is checked, uncheck the others
  ...
  const renderSectionContent = () => {
    switch (activeSection) {
        ...
        return (
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 p-6 border rounded-xl bg-gray-50">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Dependent 1</label>
      ...
      case 3: // New Section: Contact Information
        return (
          <div className="grid grid-cols-1 gap-8">
      ...
      case 4: // New Section: Work Information
        return (
          <div className="grid grid-cols-1 gap-8">
      ...
      case 5: // New Section: Bank Information
        return (
          <div className="grid grid-cols-1 gap-8">
