...
const PhoneContactSchema = new Schema<IPhoneContact>(
  {
    personalIdentityId: { type: Schema.Types.ObjectId, ref: 'EmployeeInformation', required: true },
    phoneType: { type: String, required: true },
    isPrimary: { type: Boolean, default: false },
    countryCode: { type: String, required: false, maxlength: 5 },
    phoneNumber: { type: Number, required: false, maxlength: 20 },
