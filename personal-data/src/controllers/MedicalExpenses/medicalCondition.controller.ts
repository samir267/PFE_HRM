...
export class MedicalConditionController {
  static async create(req: Request, res: Response) {
    try {
      ...
      kafka.produce('medical-expense-events', { type: 'CONDITION_CREATED', data: condition });
  ...
  static async update(req: Request, res: Response) {
    ...
    try {
      ...
      kafka.produce('medical-expense-events', { type: 'CONDITION_UPDATED', data: updated });
  ...
  static async delete(req: Request, res: Response) {
    try {
      ...
      kafka.produce('medical-expense-events', { type: 'CONDITION_DELETED', data: deleted });
